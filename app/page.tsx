    ...
    <>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg {
          ...
          background:
            ...
            radial-gradient(ellipse 40% 60% at 50% 100%, rgba(108,63,255,0.04) 0%, transparent 60%);
        }
        ...
        .badge {
          ...
          font-size: 12px; font-weight: 500; color: #a88fff;
        ...
        .btn-main {
          background: linear-gradient(135deg, #6c3fff, #9f6fff);
        ...
        .btn-main:hover:not(:disabled) {
          ...
          box-shadow: 0 8px 28px rgba(108,63,255,0.55);
        }
        ...
        .loader {
          ...
          gap: 12px; padding: 32px 0; color: var(--muted); font-size: 14px;
          animation: fadeUp 0.3s ease both;
        }

        .spinner {
          width: 18px; height: 18px;
          border: 2px solid rgba(108,63,255,0.2);
        ...
        .dl-btn {
          ...
          background: linear-gradient(135deg, rgba(108,63,255,0.15), rgba(0,194,255,0.1));
          border: 1px solid rgba(108,63,255,0.35);
          border-radius: 12px;
          color: #a88fff; text-decoration: none;
          font-family: 'Syne', sans-serif; font-size: 15px; font-weight: 700;
          transition: background 0.2s, border-color 0.2s, transform 0.1s;
        }

        .dl-btn:hover {
          background: linear-gradient(135deg, rgba(108,63,255,0.25), rgba(0,194,255,0.15));
      ...
      <main>
        <div className="header">
          ...
          <p className="subtitle">Télécharge en HD, Full HD ou 4K en quelques secondes</p>
              ...
              <div className="result-body">
                  ...
                  <>
                    ...
                    <div className="quality-grid">
                      {info.qualities.map((q) => (
                        <button
                          key={q.label}
                          className={`quality-btn${q.height >= 2160 ? " quality-4k" : ""}${selectedQuality?.label === q.label ? " active" : ""}`}
                ...
                {selectedQuality && (
                  ...
                  >
                    ...
                    Télécharger en {selectedQuality.label}
                  </a>
                )}
              </div>
            </div>
